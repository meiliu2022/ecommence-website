...
export class CartService {
  ...
  remove(theCartItem: CartItem) {
    ...
    //if found, remmove the item from the array at the given index
    if (itemIndex > -1) {
      this.cartItems.splice(itemIndex, 1); //splice is to remove the item from array
      this.ccomputeCartTotals();
    }
