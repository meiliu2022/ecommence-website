...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const theFirstName = JSON.parse(this.storage.getItem('firstName'));
    ...
    this.luv2ShopFormService.getCreditCardYears().subscribe(
      data => {
        console.log("Rectrieved credit card years: " + JSON.stringify(data));
  ...
  getStates(formGroupName: String) {
    ...
    const formGroup = this.checkoutFormGroup?.get(formGroupName as string);
